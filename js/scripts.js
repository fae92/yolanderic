...
! function(e) {
    ...
    e(document).ready(function() {
        Lilac = {
            ...
            build: function() {
                var t = this;
                t.preloader(), t.navigation(), t.createMobileMenu(), t.heroHeight(), t.curvedText(), t.wiselycheck(), e("input, textarea").placeholder(), t.bgImageGrid(), t.googleMap(), t.getLatestTweets(), t.getInstagram(), t.createPrettyPhoto(), t.createOwlSliders(), t.createGallery(), t.countdown(), t.parallaxItems(), t.startNiceScroll()
            },
            events: function() {
                var e = this;
